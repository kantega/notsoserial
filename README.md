...
> Please note: invoker-defender only does what it does. It does not fix the problem with deserialization attacks. It only knowns about and unserializes some well known classes. It cannot protect you from deserializing other vulnerable classes.
